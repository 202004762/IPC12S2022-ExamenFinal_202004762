...
public class ExamenFinal {
    ...
    public static void Vacas(){
        ...
        String pesoVacas,lecheVacas;
        Scanner sc = new Scanner(System.in);
        
        System.out.print("Ingrese el numero de vacas disponibles para la venta: ");
        int numVacas = sc.nextInt();
        
        System.out.print("Peso limite del camiono en kilogramos: ");
        int pesoMax = sc.nextInt();
        
        System.out.print("Lista separada por comas de pesos de vacas: ");
        pesoVacas = sc.next();
        
        System.out.print("Lista separa por comas de produccion de leche de vaca: ");
        lecheVacas = sc.next();
        
        List<String> peso = Arrays.asList(pesoVacas.split("\\s*,\\s*"));
